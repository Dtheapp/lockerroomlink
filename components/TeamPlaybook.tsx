              ...
              {canManagePlayType(selectedPlayType) && (
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-colors ${
                    ...
                    : 'bg-purple-500 dark:bg-orange-500 hover:bg-purple-600 dark:hover:bg-orange-600 text-white'
                  }`}
                >
                ...
                <div className="flex items-center gap-2">
                        ...
                        <div className="max-h-48 overflow-y-auto">
                          <button
                            ...
                            className={`w-full px-3 py-2 text-left text-sm hover:bg-slate-100 dark:hover:bg-zinc-800 ${
                              !filterFormationId ? 'bg-purple-50 dark:bg-orange-900/20 text-purple-600 dark:text-orange-400' : 'text-slate-700 dark:text-slate-300'
                            }`}
                          >
                            All Formations
                          </button>
                          {filteredFormations.map(formation => (
                            <button
                              ...
                              className={`w-full px-3 py-2 text-left text-sm hover:bg-slate-100 dark:hover:bg-zinc-800 ${
                                filterFormationId === formation.id ? 'bg-purple-50 dark:bg-orange-900/20 text-purple-600 dark:text-orange-400' : 'text-slate-700 dark:text-slate-300'
                              }`}
                            >
                              {formation.name}
                            </button>
                  ...
                  {filterFormationId && (
                    <button
                      ...
                      className="text-xs text-slate-500 hover:text-purple-500 dark:hover:text-orange-400"
                    >
                      Clear
                    </button>
                  )}
          ...
          <div className="p-4">
            {loadingPlays ? (
              <div className="text-center py-12">
                <div className="w-8 h-8 border-4 border-purple-500 dark:border-orange-500 border-t-transparent rounded-full animate-spin mx-auto mb-3" />
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-2 flex-wrap mt-1">
                              {/* Formation Tag */}
                              {play.formationName && (
                                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-xs font-medium bg-purple-100 dark:bg-orange-900/30 text-purple-700 dark:text-orange-400">
        ...
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-white/95 dark:bg-zinc-900/95 backdrop-blur-xl rounded-xl w-full max-w-lg overflow-hidden shadow-2xl border border-slate-200/50 dark:border-zinc-700/50">
            ...
            <div className={`p-4 flex items-center justify-between ${
              ...
              : 'bg-purple-500 dark:bg-orange-500'
            }`}>
              <div className="flex items-center gap-3">
            ...
            <div className="p-4 max-h-[300px] overflow-y-auto">
              {loadingCoachPlays ? (
                <div className="text-center py-8">
                  <div className="w-6 h-6 border-2 border-purple-500 dark:border-orange-500 border-t-transparent rounded-full animate-spin mx-auto mb-2" />
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                          ...
                          : 'bg-purple-100 dark:bg-orange-900/50'
                        }`}>
                          {play.category === 'Offense' && <Sword className="w-5 h-5 text-blue-500" />}
                          {play.category === 'Defense' && <Shield className="w-5 h-5 text-red-500" />}
                          {play.category === 'Special Teams' && <Zap className="w-5 h-5 text-purple-500 dark:text-orange-400" />}
                        </div>
                        ...
                        {selectedPlayToAdd === play.id && (
                          <div className="w-5 h-5 bg-purple-500 dark:bg-orange-500 rounded-full flex items-center justify-center">
          ...
          <div className="bg-white/95 dark:bg-zinc-900/95 backdrop-blur-xl rounded-xl w-full max-w-md overflow-hidden shadow-2xl border border-slate-200/50 dark:border-zinc-700/50">
            ...
            <div className="bg-gradient-to-r from-purple-600 to-purple-500 dark:from-orange-600 dark:to-orange-500 p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-purple-100 dark:text-orange-100 text-sm">
            ...
            <div className="p-6 space-y-4">
              {loadingRoster ? (
                <div className="flex items-center justify-center py-8">
                  <div className="w-8 h-8 border-4 border-purple-500 dark:border-orange-500 border-t-transparent rounded-full animate-spin" />
                </div>
              ) : roster.length === 0 ? (
                <div className="text-center py-8">
            ...
            <div className="border-t border-slate-200/50 dark:border-zinc-700/50 p-4 flex gap-3">
              ...
              <button
                ...
                className="flex-1 py-2.5 bg-purple-600 dark:bg-orange-500 hover:bg-purple-700 dark:hover:bg-orange-600 text-white rounded-lg font-medium flex items-center justify-center gap-2 transition-colors disabled:opacity-50"
              >
                {savingAssignment ? (
                  <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" />
                ) : (
