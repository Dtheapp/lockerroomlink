    ...
    <div className="min-h-screen bg-gray-900 pb-20">
      ...
      <div className="bg-gray-800 border-b border-gray-700">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold text-white">Grievance Management</h1>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="flex flex-col lg:flex-row gap-6">
                ...
                {filteredGrievances.map((grievance) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left bg-gray-800 hover:bg-gray-750 border rounded-xl p-4 transition-all ${
                    ...
                    >
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1 min-w-0">
                          ...
                          <h3 className="text-white font-medium truncate">{grievance.title}</h3>
          ...
          {/* Detail Panel */}
          {selectedGrievance && (
            <div className="lg:w-[400px] bg-gray-800 rounded-xl overflow-hidden sticky top-4">
              <div className="p-4 border-b border-gray-700">
                <div className="flex items-center justify-between">
                  <h2 className="text-lg font-semibold text-white">Grievance Details</h2>
                  <button
              ...
              <div className="p-4 space-y-4 max-h-[calc(100vh-200px)] overflow-y-auto">
                ...
                {/* Title & Description */}
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">{selectedGrievance.title}</h3>
                  <p className="text-gray-300 whitespace-pre-wrap">{selectedGrievance.description}</p>
                </div>

                {/* Type & Date */}
                <div className="flex items-center gap-4 text-sm">
                  <span className="text-gray-400">Type: <span className="text-white">{selectedGrievance.type?.replace('_', ' ')}</span></span>
                ...
                {submitterInfo && (
                  <div className="bg-gray-700/50 rounded-lg p-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-white">{submitterInfo.name}</span>
                      <span className="text-xs text-gray-500">({submitterInfo.role})</span>
                    </div>
                  </div>
                )}
                ...
                {teamInfo && (
                  <div className="bg-gray-700/50 rounded-lg p-3">
                    <p className="text-xs text-gray-400 mb-1">Related Team</p>
                    <div className="flex items-center gap-2">
